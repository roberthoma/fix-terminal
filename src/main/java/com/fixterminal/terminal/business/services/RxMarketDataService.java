...
public class RxMarketDataService {
    ...
    @Autowired
    public RxMarketDataService(RxDicInstruments instrumentsDic){
        this.instrumentsDic = instrumentsDic;
    }

    public  List<RxMarketDataVO> messageToList(Message message, SessionID sessionId) throws FieldNotFound {
